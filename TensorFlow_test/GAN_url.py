...
# TODO：数据准备
mnist = input_data.read_data_sets('D:\\ML\\TensorFlow_test\\data\\MNIST_data')
...
def get_loss(inputs_real, inputs_noise, image_depth, smooth=0.1):
    ...
    d_loss_fake = tf.reduce_mean(
        tf.nn.sigmoid_cross_entropy_with_logits(logits=d_logits_fake, labels=tf.zeros_like(d_outputs_fake)))
